...
heroCreator.populateGrid = function(gridDiv, hero_array){
    for(const hero of hero_array){
        ...
        // write "heroCreator.createCharSheet(hero)"
...
// BONUS: Currently, the ".createInfoDivonly()" method only 
// adds the content for each hero object, but when the content is
// displayed to the user, they don't see a label, such as "Name: "
// or "Story: ". Include these descriptors before each text element 
