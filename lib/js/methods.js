...
heroCreator.createInfoDiv = function(heroObj){
    ...
    for(key of keys){
        ...
        if(Array.isArray(value)){
            p.innerHTML = `${key}: ${this.getAbilityString(value)}`;
        }else{
...
// key + value in one string, which makes it hard to style either one.
// Modify the ".createInfoDivonly()" method to ignore the "img" key and 
// allow for differential CSS styling of the key vs. the value
