...
// Create the following 6 objects based on the corresponding hero:
...
// BONUS: add 3 more Overwatch heroes from Overwatch
// BONUS: create your own hero

// Create an array called "heroes" and store all of the hero object in the array
const heroes = [
    sombra,
    doomfist,
    lucio,
